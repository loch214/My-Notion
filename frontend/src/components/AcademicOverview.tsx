      ...
      <header className="mb-8 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="relative">
            ...
            >
              {sortOrder === 'newest' ? 'Recently added' : 'Alphabetical'}
      ...
      <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
        {sortedModules.map((module) => (
          <button
            ...
            className="surface-soft group rounded-3xl p-5 text-left transition hover:-translate-y-0.5 hover:brightness-110"
          >
        ...
        <button
          ...
          className="surface rounded-3xl border border-dashed border-subtle p-5 text-left transition hover:-translate-y-0.5 hover:brightness-110"
        >
          ...
          <div className="surface-strong w-full max-w-lg rounded-[2rem] p-6 text-[color:var(--text)]">
            ...
            <form onSubmit={handleAddSubmit} className="space-y-4">
              ...
              <div className="flex gap-3 pt-2">
                <button type="button" onClick={() => setIsAdding(false)} className="surface-soft flex-1 rounded-2xl px-4 py-3 text-sm font-medium text-muted transition hover:text-[color:var(--text)]">
                  Cancel
                </button>
